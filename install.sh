...
stow --dotfiles --dir="$HOME/dotfiles/" --target="$HOME/.config/" kitty
stow --dotfiles --dir="$HOME/dotfiles/" --target="$HOME/.config/" niri
stow --dotfiles --dir="$HOME/dotfiles/" --target="$HOME/.config/" noctalia
stow --dotfiles --dir="$HOME/dotfiles/" --target="$HOME/.config/" yazi
stow --dotfiles --dir="$HOME/dotfiles/" --target="$HOME/.config/" qute
