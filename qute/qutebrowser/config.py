...
config.bind(
    "<Alt-Shift-u>",
    "spawn --userscript qute-keepassxc --key evilssouls@protonmail.com",
    mode="insert",
)
config.bind(
    "pw",
...
config.bind(
    "<Shift-Alt-a>", 'config-cycle -t colors.webpage.darkmode.enabled "true" "false"'
)
config.bind(
    "<Ctrl-a>", 'config-cycle colors.webpage.preferred_color_scheme "light" "dark"'
)
